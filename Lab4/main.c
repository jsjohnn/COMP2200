    ...
    */
    {
        ...
        char str_strtok[] = "I em a boy, and you are a girl!";
        char str_tokenize[] = "I em a boy, and you are a girl!";

        char str_strtok2[] = "he    vm  a boy,  and    you   are a   girl!";
        char str_tokenize2[] = "he    vm  a boy,  and    you   are a   girl!";
    ...
    */
    {
        const char* one_delim = " ";
        const char* mult_delim = " ,!";
        char str_strtok[] = "I am a boy, and you are a dada!";
        char str_tokenize[] = "I am a boy, and you are a dada!";

        char str_strtok2[] = "!,He    am  a boy,  and    you   are a   girl!";
        char str_tokenize2[] = "!,He    am  a boy,  and    you   are a   girl!";
        char* token_strtok = strtok(str_strtok, one_delim);
